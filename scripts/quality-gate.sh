...
export DJANGO_SETTINGS_MODULE="${DJANGO_SETTINGS_MODULE:-lzkb.settings.test}"
export LZKB_CONFIG_TYPE="${LZKB_CONFIG_TYPE:-ENV}"
export LZKB_DATA_DIR="${LZKB_DATA_DIR:-/tmp/lzkb-quality-data}"
export LZKB_DB_NAME="${LZKB_DB_NAME:-/tmp/lzkb-quality.sqlite3}"
export LZKB_DB_HOST="${LZKB_DB_HOST:-127.0.0.1}"
export LZKB_DB_PORT="${LZKB_DB_PORT:-5432}"
export LZKB_DB_USER="${LZKB_DB_USER:-root}"
export LZKB_DB_PASSWORD="${LZKB_DB_PASSWORD:-test-password}"
export LZKB_DB_ENGINE="${LZKB_DB_ENGINE:-django.db.backends.sqlite3}"
export LZKB_DB_MAX_OVERFLOW="${LZKB_DB_MAX_OVERFLOW:-10}"
export LZKB_REDIS_HOST="${LZKB_REDIS_HOST:-127.0.0.1}"
export LZKB_REDIS_PORT="${LZKB_REDIS_PORT:-6379}"
export LZKB_REDIS_PASSWORD="${LZKB_REDIS_PASSWORD:-test-password}"
export LZKB_REDIS_DB="${LZKB_REDIS_DB:-0}"
export LZKB_REDIS_MAX_CONNECTIONS="${LZKB_REDIS_MAX_CONNECTIONS:-10}"
export LZKB_ENABLE_FORCE_GC="${LZKB_ENABLE_FORCE_GC:-0}"
